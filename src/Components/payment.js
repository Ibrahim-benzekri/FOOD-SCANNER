...
export default function Payment() {
  return (
    <section id='payment' className=' w-screen min-h-screen'>
      <div className=' max-container flex justify-center items-center gap-8 padding-hero-y padding-x h-full max-xl:gap-7 max-lg:flex-col'>
        <div className=' flex-1'>
          ...
          <div className="mb-16"> 
          <Card  title="get now premium monthly" desc="this is desc 1" price="100" mod="Monthly"/>
          
          </div>
          <Card className="mt-6" title="get now premium yearly" desc="this is desc 2" price="1000" mod="Yearly"/>
        </div>
      </div>
    </section>
  )
